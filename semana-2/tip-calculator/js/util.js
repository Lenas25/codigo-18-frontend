function validateInputIfNumber(element, type, container, input) {
    ...
    if (isNaN(inputValue)) {
      input.value = inputValue.slice(0, -1);
        ...
        container.classList.add("border","border-2", "border-[#26c0ab]");
    }else{
        container.classList.remove("border","border-2","border-[#26c0ab]");
    }
     ...
     */
    if (inputValue[0] === "0") {
      container.classList.add("border","border-2", "border-red-500");
      return false;
    } else {
